...
@Api(value = "保险信息-保险赔案信息", tags = {"保险信息-保险赔案信息"})
@RequestMapping("bxxxBxpaxx")
@RestController
public class DataGaBxxxBxpaxxController {
    ...
    @Autowired
    private DataGaBxxxBxpaxxService service;

    private DataBaseController<DataGaBxxxBxpaxx> controller;
    ...
    private ResponseData UploadData(@RequestParam("file") MultipartFile file, Integer bid, Integer projectId) {
        ...
        return controller.UploadData(file, bid, DataGaBxxxBxpaxx.class);
    }
    ...
    public ResponseData UpdateData(@RequestBody DataGaBxxxBxpaxx body, Integer projectId){
        controller = new DataBaseController<>(service, dataTypeService, fileService, basePath, projectId);
    ...
    public void ExportExcel(HttpServletResponse response, Integer projectId) {
        controller = new DataBaseController<>(service, dataTypeService, fileService, basePath, projectId);
        controller.ExportExcel("保险信息-保险赔案信息", DataGaBxxxBxpaxx.class, response);
    }
}
