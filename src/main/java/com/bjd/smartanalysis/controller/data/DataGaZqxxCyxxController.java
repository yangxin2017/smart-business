...
@Api(value = "证券信息-持有信息", tags = {"证券信息-持有信息"})
@RequestMapping("zqxxCyxx")
@RestController
public class DataGaZqxxCyxxController {
    ...
    @Autowired
    private DataGaZqxxCyxxService service;

    private DataBaseController<DataGaZqxxCyxx> controller;
    ...
    private ResponseData UploadData(@RequestParam("file") MultipartFile file, Integer bid, Integer projectId) {
        ...
        return controller.UploadData(file, bid, DataGaZqxxCyxx.class);
    }
    ...
    public ResponseData UpdateData(@RequestBody DataGaZqxxCyxx body, Integer projectId){
        controller = new DataBaseController<>(service, dataTypeService, fileService, basePath, projectId);
    ...
    public void ExportExcel(HttpServletResponse response, Integer projectId) {
        controller = new DataBaseController<>(service, dataTypeService, fileService, basePath, projectId);
        controller.ExportExcel("证券信息-持有信息", DataGaZqxxCyxx.class, response);
    }
