...
import com.bjd.smartanalysis.entity.data.DataGaTlspxx;
import com.bjd.smartanalysis.service.DataFileService;
import com.bjd.smartanalysis.service.DataTypeService;
import com.bjd.smartanalysis.service.data.DataGaTlspxxService;
...
@Api(value = "铁路售票信息", tags = {"铁路售票信息"})
@RequestMapping("tlspxx")
@RestController
public class DataGaTlspxxController {
    ...
    @Autowired
    private DataGaTlspxxService service;

    private DataBaseController<DataGaTlspxx> controller;
    ...
    private ResponseData UploadData(@RequestParam("file") MultipartFile file, Integer bid, Integer projectId) {
        ...
        return controller.UploadData(file, bid, DataGaTlspxx.class);
    }
    ...
    public void ExportExcel(HttpServletResponse response, Integer projectId) {
        controller = new DataBaseController<>(service, dataTypeService, fileService, basePath, projectId);
        controller.ExportExcel("铁路售票信息", DataGaTlspxx.class, response);
    }
    ...
    public ResponseData UpdateData(@RequestBody DataGaTlspxx body, Integer projectId){
        controller = new DataBaseController<>(service, dataTypeService, fileService, basePath, projectId);
    ...
    private ResponseData RemoveAllData(Integer projectId) {
        QueryWrapper<DataGaTlspxx> queryWrapper = new QueryWrapper<>();
