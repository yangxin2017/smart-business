...
@Api(value = "企业登记信息-清算基本信息", tags = {"企业登记信息-清算基本信息"})
@RequestMapping("qydjxxQsjbxx")
@RestController
public class DataGaQydjxxQsjbxxController {
    ...
    @Autowired
    private DataGaQydjxxQsjbxxService service;

    private DataBaseController<DataGaQydjxxQsjbxx> controller;
    ...
    private ResponseData UploadData(@RequestParam("file") MultipartFile file, Integer bid, Integer projectId) {
        ...
        return controller.UploadData(file, bid, DataGaQydjxxQsjbxx.class);
    }
    ...
    public ResponseData UpdateData(@RequestBody DataGaQydjxxQsjbxx body, Integer projectId){
        controller = new DataBaseController<>(service, dataTypeService, fileService, basePath, projectId);
    ...
    public void ExportExcel(HttpServletResponse response, Integer projectId) {
        controller = new DataBaseController<>(service, dataTypeService, fileService, basePath, projectId);
        controller.ExportExcel("企业登记信息-清算基本信息", DataGaQydjxxQsjbxx.class, response);
    }
}
