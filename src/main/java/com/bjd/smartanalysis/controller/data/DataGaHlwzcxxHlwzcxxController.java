...
@Api(value = "互联网注册信息-互联网注册信息", tags = {"互联网注册信息-互联网注册信息"})
@RequestMapping("hlwzcxxHlwzcxx")
@RestController
public class DataGaHlwzcxxHlwzcxxController {
    ...
    @Autowired
    private DataGaHlwzcxxHlwzcxxService service;

    private DataBaseController<DataGaHlwzcxxHlwzcxx> controller;
    ...
    private ResponseData UploadData(@RequestParam("file") MultipartFile file, Integer bid, Integer projectId) {
        ...
        return controller.UploadData(file, bid, DataGaHlwzcxxHlwzcxx.class);
    }
    ...
    public ResponseData UpdateData(@RequestBody DataGaHlwzcxxHlwzcxx body, Integer projectId){
        controller = new DataBaseController<>(service, dataTypeService, fileService, basePath, projectId);
    ...
    public void ExportExcel(HttpServletResponse response, Integer projectId) {
        controller = new DataBaseController<>(service, dataTypeService, fileService, basePath, projectId);
        controller.ExportExcel("互联网注册信息-互联网注册信息", DataGaHlwzcxxHlwzcxx.class, response);
    }
