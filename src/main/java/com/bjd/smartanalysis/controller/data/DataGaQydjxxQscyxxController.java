...
@Api(value = "企业登记信息-清算成员信息", tags = {"企业登记信息-清算成员信息"})
@RequestMapping("qydjxxQscyxx")
@RestController
public class DataGaQydjxxQscyxxController {
    ...
    @Autowired
    private DataGaQydjxxQscyxxService service;

    private DataBaseController<DataGaQydjxxQscyxx> controller;
    ...
    private ResponseData UploadData(@RequestParam("file") MultipartFile file, Integer bid, Integer projectId) {
        ...
        return controller.UploadData(file, bid, DataGaQydjxxQscyxx.class);
    }
    ...
    public ResponseData UpdateData(@RequestBody DataGaQydjxxQscyxx body, Integer projectId){
        controller = new DataBaseController<>(service, dataTypeService, fileService, basePath, projectId);
    ...
    public void ExportExcel(HttpServletResponse response, Integer projectId) {
        controller = new DataBaseController<>(service, dataTypeService, fileService, basePath, projectId);
        controller.ExportExcel("企业登记信息-清算成员信息", DataGaQydjxxQscyxx.class, response);
    }
