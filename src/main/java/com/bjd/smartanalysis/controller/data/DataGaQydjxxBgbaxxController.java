...
@Api(value = "企业登记信息-变更备案信息", tags = {"企业登记信息-变更备案信息"})
@RequestMapping("qydjxxBgbaxx")
@RestController
public class DataGaQydjxxBgbaxxController {
    ...
    @Autowired
    private DataGaQydjxxBgbaxxService service;

    private DataBaseController<DataGaQydjxxBgbaxx> controller;
    ...
    private ResponseData UploadData(@RequestParam("file") MultipartFile file, Integer bid, Integer projectId) {
        ...
        return controller.UploadData(file, bid, DataGaQydjxxBgbaxx.class);
    }
    ...
    public ResponseData UpdateData(@RequestBody DataGaQydjxxBgbaxx body, Integer projectId){
        controller = new DataBaseController<>(service, dataTypeService, fileService, basePath, projectId);
    ...
    public void ExportExcel(HttpServletResponse response, Integer projectId) {
        controller = new DataBaseController<>(service, dataTypeService, fileService, basePath, projectId);
        controller.ExportExcel("企业登记信息-变更备案信息", DataGaQydjxxBgbaxx.class, response);
    }
}
