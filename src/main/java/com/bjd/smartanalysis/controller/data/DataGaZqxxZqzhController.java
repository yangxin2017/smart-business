...
@Api(value = "证券信息-证券账户", tags = {"证券信息-证券账户"})
@RequestMapping("zqxxZqzh")
@RestController
public class DataGaZqxxZqzhController {
    ...
    @Autowired
    private DataGaZqxxZqzhService service;

    private DataBaseController<DataGaZqxxZqzh> controller;
    ...
    private ResponseData UploadData(@RequestParam("file") MultipartFile file, Integer bid, Integer projectId) {
        ...
        return controller.UploadData(file, bid, DataGaZqxxZqzh.class);
    }
    ...
    public ResponseData UpdateData(@RequestBody DataGaZqxxZqzh body, Integer projectId){
        controller = new DataBaseController<>(service, dataTypeService, fileService, basePath, projectId);
    ...
    public void ExportExcel(HttpServletResponse response, Integer projectId) {
        controller = new DataBaseController<>(service, dataTypeService, fileService, basePath, projectId);
        controller.ExportExcel("证券信息-证券账户", DataGaZqxxZqzh.class, response);
    }
