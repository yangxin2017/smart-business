...
@Api(value = "企业登记信息-联络员信息", tags = {"企业登记信息-联络员信息"})
@RequestMapping("qydjxxLlyxx")
@RestController
public class DataGaQydjxxLlyxxController {
    ...
    @Autowired
    private DataGaQydjxxLlyxxService service;

    private DataBaseController<DataGaQydjxxLlyxx> controller;
    ...
    private ResponseData UploadData(@RequestParam("file") MultipartFile file, Integer bid, Integer projectId) {
        ...
        return controller.UploadData(file, bid, DataGaQydjxxLlyxx.class);
    }
    ...
    public ResponseData UpdateData(@RequestBody DataGaQydjxxLlyxx body, Integer projectId){
        controller = new DataBaseController<>(service, dataTypeService, fileService, basePath, projectId);
    ...
    public void ExportExcel(HttpServletResponse response, Integer projectId) {
        controller = new DataBaseController<>(service, dataTypeService, fileService, basePath, projectId);
        controller.ExportExcel("企业登记信息-联络员信息", DataGaQydjxxLlyxx.class, response);
    }
}
