...
@Api(value = "保险信息-保险保单信息", tags = {"保险信息-保险保单信息"})
@RequestMapping("bxxxBxbdxx")
@RestController
public class DataGaBxxxBxbdxxController {
    ...
    @Autowired
    private DataGaBxxxBxbdxxService service;

    private DataBaseController<DataGaBxxxBxbdxx> controller;
    ...
    private ResponseData UploadData(@RequestParam("file") MultipartFile file, Integer bid, Integer projectId) {
        ...
        return controller.UploadData(file, bid, DataGaBxxxBxbdxx.class);
    }
    ...
    public ResponseData UpdateData(@RequestBody DataGaBxxxBxbdxx body, Integer projectId){
        controller = new DataBaseController<>(service, dataTypeService, fileService, basePath, projectId);
    ...
    public void ExportExcel(HttpServletResponse response, Integer projectId) {
        controller = new DataBaseController<>(service, dataTypeService, fileService, basePath, projectId);
        controller.ExportExcel("保险信息-保险保单信息", DataGaBxxxBxbdxx.class, response);
    }
