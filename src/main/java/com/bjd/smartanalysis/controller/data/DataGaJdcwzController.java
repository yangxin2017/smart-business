...
import com.bjd.smartanalysis.entity.data.DataGaCrjzj;
import com.bjd.smartanalysis.entity.data.DataGaJdcwz;
import com.bjd.smartanalysis.service.DataFileService;
import com.bjd.smartanalysis.service.DataTypeService;
import com.bjd.smartanalysis.service.data.DataGaJdcwzService;
...
@Api(value = "机动车违章", tags = {"机动车违章"})
@RequestMapping("jdcwz")
@RestController
public class DataGaJdcwzController {
    ...
    @Autowired
    private DataGaJdcwzService service;

    private DataBaseController<DataGaJdcwz> controller;
    ...
    private ResponseData UploadData(@RequestParam("file") MultipartFile file, Integer bid, Integer projectId) {
        ...
        return controller.UploadData(file, bid, DataGaJdcwz.class);
    }
    ...
    public void ExportExcel(HttpServletResponse response, Integer projectId) {
        controller = new DataBaseController<>(service, dataTypeService, fileService, basePath, projectId);
        controller.ExportExcel("机动车违章", DataGaJdcwz.class, response);
    }
    ...
    public ResponseData UpdateData(@RequestBody DataGaJdcwz body, Integer projectId){
        controller = new DataBaseController<>(service, dataTypeService, fileService, basePath, projectId);
    ...
    private ResponseData RemoveAllData(Integer projectId) {
        QueryWrapper<DataGaJdcwz> queryWrapper = new QueryWrapper<>();
