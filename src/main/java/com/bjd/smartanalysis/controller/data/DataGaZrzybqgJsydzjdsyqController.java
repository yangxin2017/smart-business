...
@Api(value = "自然资源部全国-建设用地宅基地使用权", tags = {"自然资源部全国-建设用地宅基地使用权"})
@RequestMapping("zrzybqgJsydzjdsyq")
@RestController
public class DataGaZrzybqgJsydzjdsyqController {
    ...
    @Autowired
    private DataGaZrzybqgJsydzjdsyqService service;

    private DataBaseController<DataGaZrzybqgJsydzjdsyq> controller;
    ...
    private ResponseData UploadData(@RequestParam("file") MultipartFile file, Integer bid, Integer projectId) {
        ...
        return controller.UploadData(file, bid, DataGaZrzybqgJsydzjdsyq.class);
    }
    ...
    public ResponseData UpdateData(@RequestBody DataGaZrzybqgJsydzjdsyq body, Integer projectId){
        controller = new DataBaseController<>(service, dataTypeService, fileService, basePath, projectId);
    ...
    public void ExportExcel(HttpServletResponse response, Integer projectId) {
        controller = new DataBaseController<>(service, dataTypeService, fileService, basePath, projectId);
        controller.ExportExcel("自然资源部全国-建设用地宅基地使用权", DataGaZrzybqgJsydzjdsyq.class, response);
    }
