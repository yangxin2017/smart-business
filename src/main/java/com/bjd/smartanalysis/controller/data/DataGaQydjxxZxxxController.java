...
@Api(value = "企业登记信息-注销信息", tags = {"企业登记信息-注销信息"})
@RequestMapping("qydjxxZxxx")
@RestController
public class DataGaQydjxxZxxxController {
    ...
    @Autowired
    private DataGaQydjxxZxxxService service;

    private DataBaseController<DataGaQydjxxZxxx> controller;
    ...
    private ResponseData UploadData(@RequestParam("file") MultipartFile file, Integer bid, Integer projectId) {
        ...
        return controller.UploadData(file, bid, DataGaQydjxxZxxx.class);
    }
    ...
    public ResponseData UpdateData(@RequestBody DataGaQydjxxZxxx body, Integer projectId){
        controller = new DataBaseController<>(service, dataTypeService, fileService, basePath, projectId);
    ...
    public void ExportExcel(HttpServletResponse response, Integer projectId) {
        controller = new DataBaseController<>(service, dataTypeService, fileService, basePath, projectId);
        controller.ExportExcel("企业登记信息-注销信息", DataGaQydjxxZxxx.class, response);
    }
}
