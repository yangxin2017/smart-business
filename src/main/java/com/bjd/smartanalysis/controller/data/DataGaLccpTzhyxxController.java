...
@Api(value = "理财产品-投资行业信息", tags = {"理财产品-投资行业信息"})
@RequestMapping("lccpTzhyxx")
@RestController
public class DataGaLccpTzhyxxController {
    ...
    @Autowired
    private DataGaLccpTzhyxxService service;

    private DataBaseController<DataGaLccpTzhyxx> controller;
    ...
    private ResponseData UploadData(@RequestParam("file") MultipartFile file, Integer bid, Integer projectId) {
        ...
        return controller.UploadData(file, bid, DataGaLccpTzhyxx.class);
    }
    ...
    public ResponseData UpdateData(@RequestBody DataGaLccpTzhyxx body, Integer projectId){
        controller = new DataBaseController<>(service, dataTypeService, fileService, basePath, projectId);
    ...
    public void ExportExcel(HttpServletResponse response, Integer projectId) {
        controller = new DataBaseController<>(service, dataTypeService, fileService, basePath, projectId);
        controller.ExportExcel("理财产品-投资行业信息", DataGaLccpTzhyxx.class, response);
    }
