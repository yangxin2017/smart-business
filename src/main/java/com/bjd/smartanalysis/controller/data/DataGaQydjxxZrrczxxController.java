...
@Api(value = "企业登记信息-自然人出资信息", tags = {"企业登记信息-自然人出资信息"})
@RequestMapping("qydjxxZrrczxx")
@RestController
public class DataGaQydjxxZrrczxxController {
    ...
    @Autowired
    private DataGaQydjxxZrrczxxService service;

    private DataBaseController<DataGaQydjxxZrrczxx> controller;
    ...
    private ResponseData UploadData(@RequestParam("file") MultipartFile file, Integer bid, Integer projectId) {
        ...
        return controller.UploadData(file, bid, DataGaQydjxxZrrczxx.class);
    }
    ...
    public ResponseData UpdateData(@RequestBody DataGaQydjxxZrrczxx body, Integer projectId){
        controller = new DataBaseController<>(service, dataTypeService, fileService, basePath, projectId);
    ...
    public void ExportExcel(HttpServletResponse response, Integer projectId) {
        controller = new DataBaseController<>(service, dataTypeService, fileService, basePath, projectId);
        controller.ExportExcel("企业登记信息-自然人出资信息", DataGaQydjxxZrrczxx.class, response);
    }
}
