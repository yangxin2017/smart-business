...
@Api(value = "铁路同行人-同行人员客票信息", tags = {"铁路同行人-同行人员客票信息"})
@RequestMapping("tltxrTxrykpxx")
@RestController
public class DataGaTltxrTxrykpxxController {
    ...
    @Autowired
    private DataGaTltxrTxrykpxxService service;

    private DataBaseController<DataGaTltxrTxrykpxx> controller;
    ...
    private ResponseData UploadData(@RequestParam("file") MultipartFile file, Integer bid, Integer projectId) {
        ...
        return controller.UploadData(file, bid, DataGaTltxrTxrykpxx.class);
    }
    ...
    public ResponseData UpdateData(@RequestBody DataGaTltxrTxrykpxx body, Integer projectId){
        controller = new DataBaseController<>(service, dataTypeService, fileService, basePath, projectId);
    ...
    public void ExportExcel(HttpServletResponse response, Integer projectId) {
        controller = new DataBaseController<>(service, dataTypeService, fileService, basePath, projectId);
        controller.ExportExcel("铁路同行人-同行人员客票信息", DataGaTltxrTxrykpxx.class, response);
    }
