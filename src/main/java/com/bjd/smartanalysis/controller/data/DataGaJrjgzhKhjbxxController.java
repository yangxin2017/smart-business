...
@Api(value = "金融机构账户-客户基本信息", tags = {"金融机构账户-客户基本信息"})
@RequestMapping("jrjgzhKhjbxx")
@RestController
public class DataGaJrjgzhKhjbxxController {
    ...
    @Autowired
    private DataGaJrjgzhKhjbxxService service;

    private DataBaseController<DataGaJrjgzhKhjbxx> controller;
    ...
    private ResponseData UploadData(@RequestParam("file") MultipartFile file, Integer bid, Integer projectId) {
        ...
        return controller.UploadData(file, bid, DataGaJrjgzhKhjbxx.class);
    }
    ...
    public ResponseData UpdateData(@RequestBody DataGaJrjgzhKhjbxx body, Integer projectId){
        controller = new DataBaseController<>(service, dataTypeService, fileService, basePath, projectId);
