...
@Api(value = "自然资源部", tags = {"自然资源部"})
@RequestMapping("zrzyb")
@RestController
public class DataGaZrzybController {
    ...
    @Autowired
    private DataGaZrzybService service;

    private DataBaseController<DataGaZrzyb> controller;
    ...
    private ResponseData UploadData(@RequestParam("file") MultipartFile file, Integer bid, Integer projectId) {
        ...
        return controller.UploadData(file, bid, DataGaZrzyb.class);
    }
    ...
    public ResponseData UpdateData(@RequestBody DataGaZrzyb body, Integer projectId){
        controller = new DataBaseController<>(service, dataTypeService, fileService, basePath, projectId);
    ...
    public void ExportExcel(HttpServletResponse response, Integer projectId) {
        controller = new DataBaseController<>(service, dataTypeService, fileService, basePath, projectId);
        controller.ExportExcel("人员电子档案", DataGaZrzyb.class, response);
    }
}
