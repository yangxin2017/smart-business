...
@Api(value = "机构法人信息", tags = {"机构法人信息"})
@RequestMapping("jgfrxx")
@RestController
public class DataGaJgfrxxController {
    ...
    @Autowired
    private DataGaJgfrxxService service;

    private DataBaseController<DataGaJgfrxx> controller;
    ...
    private ResponseData UploadData(@RequestParam("file") MultipartFile file, Integer bid, Integer projectId) {
        ...
        return controller.UploadData(file, bid, DataGaJgfrxx.class);
    }
    ...
    public void ExportExcel(HttpServletResponse response, Integer projectId) {
        controller = new DataBaseController<>(service, dataTypeService, fileService, basePath, projectId);
        controller.ExportExcel("机构法人信息", DataGaJgfrxx.class, response);
    }
    ...
    public ResponseData UpdateData(@RequestBody DataGaJgfrxx body, Integer projectId){
        controller = new DataBaseController<>(service, dataTypeService, fileService, basePath, projectId);
