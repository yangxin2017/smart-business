...
@Api(value = "国税-登记信息", tags = {"国税-登记信息"})
@RequestMapping("gsDjxx")
@RestController
public class DataGaGsDjxxController {
    ...
    @Autowired
    private DataGaGsDjxxService service;

    private DataBaseController<DataGaGsDjxx> controller;
    ...
    private ResponseData UploadData(@RequestParam("file") MultipartFile file, Integer bid, Integer projectId) {
        ...
        return controller.UploadData(file, bid, DataGaGsDjxx.class);
    }
    ...
    public ResponseData UpdateData(@RequestBody DataGaGsDjxx body, Integer projectId){
        controller = new DataBaseController<>(service, dataTypeService, fileService, basePath, projectId);
    ...
    public void ExportExcel(HttpServletResponse response, Integer projectId) {
        controller = new DataBaseController<>(service, dataTypeService, fileService, basePath, projectId);
        controller.ExportExcel("国税-登记信息", DataGaGsDjxx.class, response);
    }
}
