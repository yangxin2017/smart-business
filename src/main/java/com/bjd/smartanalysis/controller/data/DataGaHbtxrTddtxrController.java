...
@Api(value = "航班同行人-同订单同行人", tags = {"航班同行人-同订单同行人"})
@RequestMapping("hbtxrTddtxr")
@RestController
public class DataGaHbtxrTddtxrController {
    ...
    @Autowired
    private DataGaHbtxrTddtxrService service;

    private DataBaseController<DataGaHbtxrTddtxr> controller;
    ...
    private ResponseData UploadData(@RequestParam("file") MultipartFile file, Integer bid, Integer projectId) {
        ...
        return controller.UploadData(file, bid, DataGaHbtxrTddtxr.class);
    }
    ...
    public ResponseData UpdateData(@RequestBody DataGaHbtxrTddtxr body, Integer projectId){
        controller = new DataBaseController<>(service, dataTypeService, fileService, basePath, projectId);
    ...
    public void ExportExcel(HttpServletResponse response, Integer projectId) {
        controller = new DataBaseController<>(service, dataTypeService, fileService, basePath, projectId);
        controller.ExportExcel("航班同行人-同订单同行人", DataGaHbtxrTddtxr.class, response);
    }
}
