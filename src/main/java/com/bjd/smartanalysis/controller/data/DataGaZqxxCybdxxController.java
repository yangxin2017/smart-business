...
@Api(value = "证券信息-持有变动信息", tags = {"证券信息-持有变动信息"})
@RequestMapping("zqxxCybdxx")
@RestController
public class DataGaZqxxCybdxxController {
    ...
    @Autowired
    private DataGaZqxxCybdxxService service;

    private DataBaseController<DataGaZqxxCybdxx> controller;
    ...
    private ResponseData UploadData(@RequestParam("file") MultipartFile file, Integer bid, Integer projectId) {
        ...
        return controller.UploadData(file, bid, DataGaZqxxCybdxx.class);
    }
    ...
    public ResponseData UpdateData(@RequestBody DataGaZqxxCybdxx body, Integer projectId){
        controller = new DataBaseController<>(service, dataTypeService, fileService, basePath, projectId);
    ...
    public void ExportExcel(HttpServletResponse response, Integer projectId) {
        controller = new DataBaseController<>(service, dataTypeService, fileService, basePath, projectId);
        controller.ExportExcel("证券信息-持有变动信息", DataGaZqxxCybdxx.class, response);
    }
