...
@Api(value = "企业登记信息-内资补充信息", tags = {"企业登记信息-内资补充信息"})
@RequestMapping("qydjxxNzbcxx")
@RestController
public class DataGaQydjxxNzbcxxController {
    ...
    @Autowired
    private DataGaQydjxxNzbcxxService service;

    private DataBaseController<DataGaQydjxxNzbcxx> controller;
    ...
    private ResponseData UploadData(@RequestParam("file") MultipartFile file, Integer bid, Integer projectId) {
        ...
        return controller.UploadData(file, bid, DataGaQydjxxNzbcxx.class);
    }
    ...
    public ResponseData UpdateData(@RequestBody DataGaQydjxxNzbcxx body, Integer projectId){
        controller = new DataBaseController<>(service, dataTypeService, fileService, basePath, projectId);
    ...
    public void ExportExcel(HttpServletResponse response, Integer projectId) {
        controller = new DataBaseController<>(service, dataTypeService, fileService, basePath, projectId);
        controller.ExportExcel("企业登记信息-内资补充信息", DataGaQydjxxNzbcxx.class, response);
    }
