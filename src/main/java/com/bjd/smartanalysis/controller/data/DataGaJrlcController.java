...
@Api(value = "金融机构金融理财", tags = {"金融机构金融理财"})
@RequestMapping("jrlc")
@RestController
public class DataGaJrlcController {
    ...
    @Autowired
    private DataGaJrlcService service;

    private DataBaseController<DataGaJrlc> controller;
    ...
    private ResponseData UploadData(@RequestParam("file") MultipartFile file, Integer bid, Integer projectId) {
        ...
        return controller.UploadData(file, bid, DataGaJrlc.class);
    }
    ...
    public ResponseData UpdateData(@RequestBody DataGaJrlc body, Integer projectId){
        controller = new DataBaseController<>(service, dataTypeService, fileService, basePath, projectId);
    ...
    public void ExportExcel(HttpServletResponse response, Integer projectId) {
        controller = new DataBaseController<>(service, dataTypeService, fileService, basePath, projectId);
        controller.ExportExcel("金融机构金融理财", DataGaJrlc.class, response);
    }
}
